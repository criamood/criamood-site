...
{
name: "Azulejo com Foto",
image: "/images/azulejo-3-2.jpg",
price: "R$ 24,90",
},
{
name: "Azulejo Presente Especial",
image: "/images/azulejo-4.jpeg",
price: "R$ 24,90",
},
];
    ...
    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <h1 className="text-5xl lg:text-6xl font-black mb-6">
          Azulejos
          <span className="text-[#bfd11a]"> Personalizados</span>
        </h1>
      ...
      <img
        src="/images/azulejo-1.png"
        alt="Azulejos Personalizados"
